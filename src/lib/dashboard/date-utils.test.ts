...
describe("mondayIndex", () => {
  // Local-component constructor (not a date-only ISO string): ISO
  // date-only strings parse as UTC midnight, which rolls back to the
  // previous local day in any timezone behind UTC and made this suite
  // fail outside UTC. `new Date(y, m, d)` is always local, matching
